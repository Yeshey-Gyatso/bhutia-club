          ...
          {/* /////home */}
            {
              language?(
                <div className=' -mt-2'> 
                    <h1><Link to="home2"  spy={true} smooth={true} offset={-70} duration={500} className=' cursor-pointer hover:text-gray-300 text-3xl '>ཁྱིམ།</Link></h1>   

                </div>

              ):(
            <h1><Link to="home2"  spy={true} smooth={true} offset={-70} duration={500}  className=' cursor-pointer hover:text-gray-300 text-lg'>Home</Link></h1>   

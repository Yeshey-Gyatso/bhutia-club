    ...
    className=" py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
      ...
      <div className=" grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <div className=" text-center text-gray-500 dark:text-gray-400">
              <img className="hover:scale-125  transition-all duration-500  mx-auto mb-4 w-36 h-36 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png" alt="Bonnie Avatar"/>
          ...
          <div className=" text-center text-gray-500 dark:text-gray-400">
              <img className="hover:scale-125  transition-all duration-500  mx-auto mb-4 w-36 h-36 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/helene-engels.png" alt="Helene Avatar"/>
              <h3 className=" mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
          ...
          <div className=" text-center text-gray-500 dark:text-gray-400">
              <img className="hover:scale-125  transition-all duration-500  mx-auto mb-4 w-36 h-36 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/jese-leos.png" alt="Jese Avatar"/>
              <h3 className=" mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                  <a href="#">Jese Leos</a>
              </h3>
              <p>SEO & Marketing</p>
          ...
          <div className=" text-center text-gray-500 dark:text-gray-400">
              <img className="hover:scale-125  transition-all duration-500  mx-auto mb-4 w-36 h-36 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/joseph-mcfall.png" alt="Joseph Avatar"/>
              <h3 className=" mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
          ...
          <div className=" text-center text-gray-500 dark:text-gray-400">
              <img className="hover:scale-125  transition-all duration-500  mx-auto mb-4 w-36 h-36 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/sofia-mcguire.png" alt="Sofia Avatar"/>
              <h3 className=" mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                  <a href="#">Lana Byrd</a>
              </h3>
              <p>Web Designer</p>
          ...
          <div className=" text-center text-gray-500 dark:text-gray-400">
              <img className="hover:scale-125  transition-all duration-500  mx-auto mb-4 w-36 h-36 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/thomas-lean.png" alt="Leslie Avatar"/>
              <h3 className=" mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
          ...
          <div className=" text-center text-gray-500 dark:text-gray-400">
              <img className="hover:scale-125  transition-all duration-500  mx-auto mb-4 w-36 h-36 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/michael-gouch.png" alt="Michael Avatar"/>
              <h3 className=" mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
          ...
          <div className=" text-center text-gray-500 dark:text-gray-400">
              <img className="hover:scale-125  transition-all duration-500  mx-auto mb-4 w-36 h-36 rounded-full" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/neil-sims.png" alt="Neil Avatar"/>
              <h3 className=" mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                  <a href="#">Neil Sims</a>
              </h3>
